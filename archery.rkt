...
(define (process-mouse a-world x y mouse-event)
  (cond
   ...
   (world-target a-world) 
   (cond
     [(and (eq? mouse-event "button-down")(or (and (< x 555)(> x 345)(< y 310)(> y 240))(and (< x 555)(> x 345)(< y 410)(> y 340))))
      (make-score
                                                                                                           0
   0
   0
   ...
   (cond
     [(and (eq? mouse-event "button-down")(or (and (< x 555)(> x 345)(< y 310)(> y 240))(and (< x 555)(> x 345)(< y 410)(> y 340))))9]
     [else(world-count a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(or (and (< x 555)(> x 345)(< y 310)(> y 240))(and (< x 555)(> x 345)(< y 410)(> y 340))))1]
     [else(world-try a-world)]) 
   (world-turn a-world)
   (world-atimer a-world)
   (world-blinks a-world)
   (world-wind a-world)
   (cond
     [(and (eq? mouse-event "button-down")(or (and (< x 555)(> x 345)(< y 310)(> y 240))(and (< x 555)(> x 345)(< y 410)(> y 340))))false]
     [else(world-stopped? a-world)])
   (world-r-t a-world)
   (world-increase? a-world)
   (world-cc a-world)
   ...
   (world-tg a-world)
   (cond
     [(and (eq? mouse-event "button-down")(and (< x 555)(> x 345)(< y 410)(> y 340)))true]
   ...
   (world-how-too? a-world)
   (cond
     [(and (eq? mouse-event "button-down")(and (< x 555)(> x 345)(< y 410)(> y 340)))false]
     [else(world-1p? a-world)])
(cond
     [(and (eq? mouse-event "button-down")(and (< x 555)(> x 345)(< y 410)(> y 340)))false]
     [else(world-2p? a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(and (< x 555)(> x 345)(< y 310)(> y 240)))true]
     [(and (eq? mouse-event "button-down")(and (< x 555)(> x 345)(< y 410)(> y 340)))false]
   ...
   (world-slider-x a-world)
   (cond
     [(and (eq? mouse-event "button-down")(or (and (< x 555)(> x 345)(< y 310)(> y 240))(and (< x 555)(> x 345)(< y 410)(> y 340))))2]
   ...
   (cond
     [(and(world-stopped? a-world)(eq? mouse-event "button-down")(eq?(world-count a-world)0))(world-loa a-world)]
     [(and(world-stopped? a-world)(eq? mouse-event "button-down")(not(eq?(world-atimer a-world)0)))(world-loa a-world)]
     [(and (world-start? a-world)(eq? mouse-event "button-down")(and (< x 897.5)(> x 857.5)(> y 2.5)(< y 42.5)))(world-loa a-world)]
     [(and(eq? mouse-event "button-down")(world-start? a-world)(world-stopped? a-world))(cons ARROW1  (world-loa a-world))]  
     [else (world-loa a-world)]) 
   (world-target a-world)  
   (process-mouse-score(world-score a-world)a-world x y mouse-event)
   (cond
     [(and(world-stopped? a-world)(eq? mouse-event "button-down")(=(world-count a-world)0))(world-count a-world)]
     [(and(world-stopped? a-world)(eq? mouse-event "button-down")(not(eq? (world-atimer a-world)0)))(world-count a-world)]
     [(and (world-start? a-world)(eq? mouse-event "button-down")(and (< x 897.5)(> x 857.5)(> y 2.5)(< y 42.5)))(world-count a-world)]
     [(and(world-stopped? a-world)(world-start? a-world)(eq? mouse-event "button-down"))(-(world-count a-world)1)]  
     [else(world-count a-world)])
   (world-try a-world)  
   (world-turn a-world)
   (cond
     [(and (world-start? a-world)(eq? mouse-event "button-down")(and (< x 897.5)(> x 857.5)(> y 2.5)(< y 42.5)))(world-atimer a-world)]
     [(and (world-stopped? a-world)(world-start? a-world)(eq? mouse-event "button-down")(eq? (world-atimer a-world)0))75]
     [(and (world-stopped? a-world)(eq? mouse-event "button-down")(not(eq? (world-atimer a-world)0)))(world-atimer a-world)]
     [else(world-atimer a-world)])  
   (world-blinks a-world)
   (world-wind a-world)
   (cond
     [(and (world-start? a-world)(eq? mouse-event "button-down")(and (< x 897.5)(> x 857.5)(> y 2.5)(< y 42.5)))(world-stopped? a-world)]
     [(and(world-start? a-world)(eq? mouse-event "button-down"))true]  
     [else(world-stopped? a-world)])
   (random 2)
   (cond
     [(and (eq? (world-cc a-world)0)(not (world-hub? a-world))(eq? mouse-event "button-down"))true]
     [(and(world-start? a-world)(eq? mouse-event "button-up"))false]
     [else (world-increase? a-world)]) 
   (cond
     [(and(eq? mouse-event "button-down")(world-start? a-world)(eq?(world-atimer a-world)0))1]
     [(and(eq? mouse-event "button-down")(not(eq?(world-atimer a-world)0)))(world-cc a-world)] 
     [else(world-cc a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(world-how-to? a-world)(and(< x 40)(> x 5)(> y 5)(< y 40)))1]
     [(and (world-how-too? a-world)(eq? mouse-event "button-down")(not(world-hub? a-world))(and (< x 135)(> x 5)(< y 65)(> y 5)))1]
     [(and (or (world-how-to? a-world)(world-how-too? a-world))(eq? mouse-event "button-down")(not(=(world-how-to a-world)7))(<(sqrt(+(expt(- x 650)2)(expt(- y 300)2)))15))(+(world-how-to a-world)1)]
     [(and (or (world-how-to? a-world)(world-how-too? a-world))(eq? mouse-event "button-down")(not(=(world-how-to a-world)1))(<(sqrt(+(expt(- x 250)2)(expt(- y 300)2)))15))(-(world-how-to a-world)1)]
     [else (world-how-to a-world)])
   (world-tg a-world)
   (cond
     [(and (or (and (> x 345)(< x 555)(> y 165)(< y 235))(and (> x 345)(< x 555)(> y 250)(< y 320))(and (> x 345)(< x 555)(> y 335)(< y 405))(and (> x 345)(< x 555)(> y 420)(< y 490))(and (> x 345)(< x 555)(> y 505)(< y 575))) (eq? mouse-event "button-down"))false]
     [(and (eq? mouse-event "button-down")(not(world-hub? a-world))(or (world-how-too? a-world)(world-stats? a-world)(world-credits? a-world))(and (< x 135)(> x 5)(< y 65)(> y 5)))true]
     [else(world-hub? a-world)])

   (cond
     [(and (world-hub? a-world)(eq? mouse-event "button-down")(and (> x 345)(< x 555)(> y 420)(< y 490)))true]
     [(and (world-stats? a-world)(eq? mouse-event "button-down")(not(world-hub? a-world))(and (< x 135)(> x 5)(< y 65)(> y 5)))false]
     [else(world-stats? a-world)])
   (cond
     [(and (world-hub? a-world)(eq? mouse-event "button-down")(and (> x 345)(< x 555)(> y 505)(< y 575)))true]
     [(and (world-credits? a-world)(eq? mouse-event "button-down")(not(world-hub? a-world))(and (< x 135)(> x 5)(< y 65)(> y 5)))false]
     [else(world-credits? a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(world-how-to? a-world)(and(< x 40)(> x 5)(> y 5)(< y 40)))false]
     [(and(world-hub? a-world)(eq? mouse-event "button-down")(or (and (> x 345)(< x 555)(> y 165)(< y 235))(and (> x 345)(< x 555)(> y 250)(< y 320))))true] 
     [else(world-how-to? a-world)]) 
   (cond
     [(and(world-hub? a-world)(eq? mouse-event "button-down")(and (> x 345)(< x 555)(> y 335)(< y 405)))true]
     [(and (world-how-too? a-world)(eq? mouse-event "button-down")(not(world-hub? a-world))(and (< x 135)(> x 5)(< y 65)(> y 5)))false]
     [else(world-how-too? a-world)])  
   (cond
     [(and (world-hub? a-world)(eq? mouse-event "button-down")(and (> x 345)(< x 555)(> y 165)(< y 235)))true]
     [else(world-1p? a-world)])
   (cond
     [(and (world-hub? a-world)(eq? mouse-event "button-down")(and (> x 345)(< x 555)(> y 250)(< y 320)))true]
     [else(world-2p? a-world)])
   (cond
     [(and (world-start? a-world)(eq? mouse-event "button-down")(and (< x 897.5)(> x 857.5)(> y 2.5)(< y 42.5)))false]
     [(and (eq? mouse-event "button-down")(world-how-to? a-world)(and(< x 40)(> x 5)(> y 5)(< y 40)))true]
     [else(world-start? a-world)])
   (cond
     [(and (world-start? a-world)(eq? mouse-event "button-down")(and (< x 897.5)(> x 857.5)(> y 2.5)(< y 42.5)))true]
     [else(world-pause? a-world)])
   (world-sure? a-world)
   (cond
     [(and(or(eq? mouse-event "button-down")(eq? mouse-event "drag"))(and (< x 420)(> x 316)(< y 545)(> y 525)))x] 
   ...
   (world-archer a-world)
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))empty] 
     [else(world-loa a-world)]) 
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))TARGET1] 
     [else(world-target a-world)])    
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))(make-score
                                                                                                           0
   0
   0
   0
   ...
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))9] 
     [else(world-count a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))1] 
     [else(world-try a-world)])  
   (world-turn a-world)
   (world-atimer a-world)
   (world-blinks a-world)
   (world-wind a-world)
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))false] 
     [else(world-stopped? a-world)])
   (world-r-t a-world)
   (world-increase? a-world) 
   (world-cc a-world) 
   ...
   (world-tg a-world)
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))true]
     [else(world-hub? a-world)])
   (cond
     [(and (not(world-sure? a-world))(eq? mouse-event "button-down")(and (< x 555)(> x 345)(< y 375)(> y 305)))true]
     [(and (not(world-sure? a-world))(world-stats? a-world)(eq? mouse-event "button-down")(not(world-hub? a-world))(and (< x 135)(> x 5)(< y 65)(> y 5)))false] 
     [else(world-stats? a-world)])
   (world-credits? a-world)
   (world-how-to? a-world)
   (cond
     [(and (not(world-sure? a-world))(eq? mouse-event "button-down")(and(< x 555)(> x 345) (< y 295) (> y 225)))true]
     [(and (not(world-sure? a-world))(world-how-too? a-world)(eq? mouse-event "button-down")(not(world-hub? a-world))(and (< x 135)(> x 5)(< y 65)(> y 5)))false]  
     [else(world-how-too? a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))false] 
     [else(world-1p? a-world)])
   ...
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))false]
     [(and (eq? mouse-event "button-down")(and(< x 555)(> x 345) (< y 215) (> y 145)))true] 
     [else(world-start? a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(and(< x 555)(> x 345) (< y 215) (> y 145)))false]
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))false]
     [else(world-pause? a-world)])
   (cond
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 395)(> y 325)))false] 
     [(and (eq? mouse-event "button-down")(world-sure? a-world)(and (< x 555)(> x 345)(< y 275)(> y 205)))false] 
     [(and (eq? mouse-event "button-down")(and (< x 555)(> x 345)(> y 385)(< y 455)))true]
